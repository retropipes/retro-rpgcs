...
public class AnnihilatorSpellBook extends SpellBook {
    ...
    protected void defineSpells() {
        final var spell0Effect = new Effect("Force Ball", 1);
        ...
        final var spell1Effect = new Effect("Super Force Ball", 1);
        ...
        final var spell2Effect = new Effect("Cutter Cloud", 1);
        ...
        final var spell3Effect = new Effect("Super Cutter Cloud", 1);
        ...
        final var spell4Effect = new Effect("Vortex", 1);
        ...
        final var spell5Effect = new Effect("Super Vortex", 1);
