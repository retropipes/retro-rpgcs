/* RetroRPGCS: An RPG */
package com.puttysoftware.retrorpgcs.shops;

import javax.swing.JOptionPane;

import com.puttysoftware.diane.gui.CommonDialogs;
import com.puttysoftware.retrorpgcs.creatures.party.PartyManager;
import com.puttysoftware.retrorpgcs.items.ArmorConstants;
import com.puttysoftware.retrorpgcs.items.Equipment;
import com.puttysoftware.retrorpgcs.items.EquipmentFactory;
import com.puttysoftware.retrorpgcs.items.EquipmentSlotConstants;
import com.puttysoftware.retrorpgcs.items.Item;
import com.puttysoftware.retrorpgcs.items.Socks;
import com.puttysoftware.retrorpgcs.items.WeaponConstants;
    ...
    private class ShopDialogGUI {
        ...
        private boolean shopStage2() {
            ...
            case ShopTypes.SHOP_TYPE_WEAPONS:
                if (Shop.this.typeResult.equals(Shop.this.typeChoices[0])) {
                    ...
                    // Choose Hand
                    final var handChoices = WeaponConstants
                            .getHandChoices();
                    final var handDefault = 0;
                    final var handResult = CommonDialogs.showInputDialog(
        ...
        private boolean shopStage4() {
            ...
            if (Shop.this.type == ShopTypes.SHOP_TYPE_WEAPONS
                ...
                final var old = playerCharacter.getItems()
                        .getEquipmentInSlot(Shop.this.index);
                if (old != null) {
                    if (old.isTwoHanded()) {
                        Shop.this.twoHanded = true;
                    }
                    final var power = old.getPotency();
                    final var bonus = power % (Shop.MAX_ENHANCEMENTS + 1) + 1;
                    Shop.this.item = EquipmentFactory
            ...
            if (Shop.this.type != ShopTypes.SHOP_TYPE_BANK) {
                // Handle inflation
                final var actualInflation = Shop.this.inflationRate / 100.0;
                final var inflatedCost = Shop.this.cost * actualInflation;
        ...
        private boolean shopStage5() {
            ...
            final var playerCharacter = PartyManager.getParty()
                    .getLeader();
            if ((Shop.this.type != ShopTypes.SHOP_TYPE_BANK) || (Shop.this.index == 0)) {
        ...
        private void shopStage6() {
            ...
            case ShopTypes.SHOP_TYPE_WEAPONS:
                ...
                if (Shop.this.typeResult.equals(Shop.this.typeChoices[0])) {
                    final var bought = EquipmentFactory
